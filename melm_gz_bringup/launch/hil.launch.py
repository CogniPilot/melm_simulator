...
def generate_launch_description():
    ...
    wheel_odom_bridge = Node(
        ...
        arguments=[
            '/world/default/model/melm/joint_state@sensor_msgs/msg/JointState[gz.msgs.Model'
            ])

    wheel_odom_throttle = Node(
        package='topic_tools',
        executable='throttle',
        arguments=['messages', '/world/default/model/melm/joint_state', '100', '/cerebri/in/wheel_odometry'],
    ...
    imu_bridge = Node(
        ...
        arguments=[
            '/world/default/model/melm/link/sensors/sensor/imu_sensor/imu@sensor_msgs/msg/Imu[gz.msgs.IMU'
            ],
        remappings=[
            ('/world/default/model/melm/link/sensors/sensor/imu_sensor/imu', '/cerebri/in/imu')
            ])
    ...
    mag_bridge = Node(
        ...
        arguments=[
            '/world/default/model/melm/link/sensors/sensor/mag_sensor/magnetometer@sensor_msgs/msg/MagneticField[gz.msgs.Magnetometer'
            ],
        remappings=[
            ('/world/default/model/melm/link/sensors/sensor/mag_sensor/magnetometer', '/cerebri/in/magnetic_field')
            ])
    ...
    nav_sat_fix_bridge = Node(
        ...
        arguments=[
            '/world/default/model/melm/link/sensors/sensor/navsat_sensor/navsat@sensor_msgs/msg/NavSatFix[gz.msgs.NavSat'
            ],
        remappings=[
            ('/world/default/model/melm/link/sensors/sensor/navsat_sensor/navsat', '/cerebri/in/nav_sat_fix')
            ])
    ...
    battery_state_bridge = Node(
        ...
        arguments=[
            '/model/melm/battery/linear_battery/state@sensor_msgs/msg/BatteryState[gz.msgs.BatteryState'
            ],
        remappings=[
            ('/model/melm/battery/linear_battery/state', '/cerebri/in/battery_state')
            ])
